...
namespace WPELibrary.Lib.PetSkillBook
{
    ...
    /// </summary>
    public static class SummonedPetSkillBookPresetSerializer
    {
        ...
        /// </summary>
        public static string Serialize(SummonedPetSkillBookPreset preset)
        {
        ...
        /// </summary>
        public static bool TryDeserialize(string json, out SummonedPetSkillBookPreset preset, out string error)
        {
            preset = null;
            error = string.Empty;
            ...
            {
                var settings = CreateSettings();
                var loaded = JsonConvert.DeserializeObject<SummonedPetSkillBookPreset>(json, settings);
                if (loaded == null)
                {
                    error = "预设内容无法解析为有效对象。";
                    return false;
                ...
                {
                    error = $"预设 schema 版本过高：{loaded.SchemaVersionProperty} > {SummonedPetSkillBookPreset.SchemaVersion}。";
                    return false;
                }
        ...
        /// </summary>
        public static SummonedPetSkillBookPreset DeserializeClone(SummonedPetSkillBookPreset source)
        {
            if (source == null)
            {
                return null;
            ...
            SummonedPetSkillBookPreset clone;
            string error;
        ...
        /// </summary>
        public static void SaveToFile(SummonedPetSkillBookPreset preset, string filePath)
        {
            if (preset == null) throw new ArgumentNullException(nameof(preset));
        ...
        /// </summary>
        public static bool TryLoadFromFile(string filePath, out SummonedPetSkillBookPreset preset, out string error)
        {
            preset = null;
            error = string.Empty;
